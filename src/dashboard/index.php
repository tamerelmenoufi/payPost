        ...
        <div class="col-md-12 p-2">
            <div class="table-responsive">
                <table class="table table-hover">
                    ...
                    <tbody>
                    <?php
                    echo $q = "select count(*) as quantidade, sum(quantidade) as total, b.combustivel, c.nome from vendas a left join combustiveis b on a.combustivel = b.codigo left join usuarios c on a.usuario = c.codigo where a.deletado != '1' group by a.combustivel order by quantidade desc";
                    $r = mysqli_query($con, $q);
